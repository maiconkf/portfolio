  ...
  return (
    ...
    >
      <Container>
        ...
        <Typography>Atualizado em: 16 de dezembro de 2023</Typography>
        <Typography pt={3}>
          ...
          &quot;GeminiAI em Portugês&quot;, que utiliza o AdMob para exibição de
          anúncios. Ao usar nosso aplicativo, você concorda com as práticas de
          privacidade descritas abaixo.
        </Typography>
        <List sx={{ listStyle: "decimal", pl: 2 }}>
          ...
          <ListItem sx={{ display: "list-item" }}>
            ...
            <List sx={{ pt: 1 }}>
              <ListItem sx={{ display: "list-item", p: 0 }}>
                <ListItemText primary="O GeminiAI em Português não se destina a crianças menores de 13 anos. Não coletamos intencionalmente informações de crianças menores de 13 anos. Se você acredita que coletamos informações de uma criança, entre em contato conosco para que possamos tomar medidas adequadas." />
              </ListItem>
            </List>
          </ListItem>
          <ListItem sx={{ display: "list-item" }}>
        ...
        <Typography pb={6}>
          Ao continuar a usar o GeminiAI em Português, você concorda com esta
          Política de Privacidade.
        </Typography>
      </Container>
    </Grid>
