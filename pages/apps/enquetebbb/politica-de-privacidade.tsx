  ...
  return (
    ...
    >
      <Container>
        ...
        <Typography>Atualizado em: 30 de dezembro de 2023</Typography>
        <Typography pt={3}>
          ...
          &quot;Enquete BBB&quot;, que utiliza o Firebase para Analytics e o
        ...
        <List sx={{ listStyle: "decimal", pl: 2 }}>
          <ListItem sx={{ display: "list-item" }}>
            ...
            >
              <ListItem sx={{ display: "list-item", pl: 0 }}>
                <ListItemText primary="O Enquete BBB utiliza o Firebase Analytics para coletar informações anônimas sobre o uso do aplicativo. Isso inclui dados sobre interações com o aplicativo, como a frequência de uso, as telas visitadas e as ações realizadas. Essas informações são usadas para melhorar a qualidade e o desempenho do aplicativo." />
              </ListItem>
            </List>
            <List
          ...
          <ListItem sx={{ display: "list-item" }}>
            ...
            >
              <ListItem sx={{ display: "list-item", pt: 1, pb: 0, px: 0 }}>
                <ListItemText primary="Melhorar o aplicativo Enquete BBB, tornando-o mais útil e eficiente." />
              </ListItem>
          ...
          <ListItem sx={{ display: "list-item" }}>
            ...
            <List sx={{ pt: 1 }}>
              <ListItem sx={{ display: "list-item", p: 0 }}>
                <ListItemText primary="O Enquete BBB não se destina a crianças menores de 13 anos. Não coletamos intencionalmente informações de crianças menores de 13 anos. Se você acredita que coletamos informações de uma criança, entre em contato conosco para que possamos tomar medidas adequadas." />
              </ListItem>
            </List>
          </ListItem>
          <ListItem sx={{ display: "list-item" }}>
        ...
        <Typography pb={6}>
          Ao continuar a usar o Enquete BBB, você concorda com esta Política de
          Privacidade.
        </Typography>
      </Container>
    </Grid>
